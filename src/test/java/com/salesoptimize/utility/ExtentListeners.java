...
public class ExtentListeners extends BaseClass implements ITestListener {
	...
	String fileName = new String(System.getProperty("user.dir") + "/Reports/SalesOptimize_"
	...
	public void onTestStart(ITestResult result) {
	    ...
	    name = firstLetter + remainingLetters+"Test";
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			if(System.getProperty("os.name").equalsIgnoreCase("xp")){					
            ...
            testLog.get()
				.fail("<details>" + "<summary>" + "<b>" + "<font color=" + "red>"
						+ "Screenshot of failure : Click to see the Failure Image ->" + "</font>" + "</b>"
						+ "</summary>" + "<a href=" + path + "><img height=1000 width=768 target=_blank src=" + path
						+ "></a>" + "</details>");
			}
