...
public class CommonMethod extends BaseClass {
	...
	public static WebElement findElement(final String objectLocater) throws IOException {
		...
		System.out.println("Locator "+ objectLocater+ " : " +objectvalue );
	...
	public static void switchToParentTab2() throws Exception {
	...
	public static void switchToParentTab1() throws Exception {
	...
	public static void closeCurrentTab() throws InterruptedException {
		...
		String one = tabs.get(0);
		String two = tabs.get(1);
	...
	public static void assertFalse(String message)throws Exception {

		
		CommonMethod.testlog("Fail", message);
	...
	public static void assertcontainsmessage(String objectLocater, String expected, String message) throws Exception {

		System.out.println(CommonMethod.getText(objectLocater));
		Assert.assertTrue(CommonMethod.GetText(objectLocater).contains(expected), message);
	...
	public static void Click(String objectLocater)throws Exception{
		JavascriptExecutor jse = (JavascriptExecutor)driver;
		WebElement element = findElement(objectLocater);
		jse.executeScript("arguments[0].scrollIntoView(true);",element);
		jse.executeScript("arguments[0].setAttribute('style', 'background:#FFBF00; border: 1px solid red;');", element);
		element.click();
	}
	
	public static String GetText(String objectLocater)throws Exception{
		JavascriptExecutor jse = (JavascriptExecutor)driver;
		WebElement element = findElement(objectLocater);
		jse.executeScript("arguments[0].scrollIntoView(true);",element);
		jse.executeScript("arguments[0].setAttribute('style', 'background:#ADFF2F; border: 1px solid red;');", element);
		return element.getText();
	}
	
	public static void SetText(String objectLocater,String value)throws Exception{
	   JavascriptExecutor jse = (JavascriptExecutor)driver;
		WebElement element = findElement(objectLocater);
		jse.executeScript("arguments[0].scrollIntoView(true);",element);
		jse.executeScript("arguments[0].setAttribute('style', 'background:#98FB98;border: 1px solid red;');", element);
